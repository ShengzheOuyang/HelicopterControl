function [sys, x0, str, ts, simStateCompliance] = GUIdisplay(t, ~, u, flag, ax, worldfile)
...
%   Copyright 1998-2020 HUMUSOFT s.r.o. and The MathWorks, Inc.
...
FigHandle = figure('Units',          'pixels', ...
                   ...
                   'IntegerHandle',  'off', ...
                   'Toolbar',        'none', ...
                   'DeleteFcn',      'GUIdisplay([], [], [], ''DeleteFigure'', [], [])', ...
                   'Visible', 'off');
...
ud.G1_Axes = axes('Position', [0.05 0.1 0.28 0.25], ...
                  ...
                  'YColor',   'w', ...
                  'XLim',     [0 stoptime]);
set(ud.G1_Axes, 'Title', title('Alpha (°)', 'Color', 'w'));
ud.XData = [];
ud.Y1Data = [];
...
ud.G2_Axes = axes('Position', [0.37 0.1 0.28 0.25], ...
                  ...
                  'YColor',   'w', ...
                  'XLim',     [0 stoptime]);
set(ud.G2_Axes, 'Title', title('Beta (°)', 'Color', 'w'));
ud.XData = [];
ud.Y2Data = [];
...
ud.G3_Axes = axes('Position', [0.69 0.1 0.28 0.25], ...
                  ...
                  'YColor',   'w', ...
                  'XLim',     [0 stoptime]);
set(ud.G3_Axes, 'Title', title('Gamma (°)', 'Color', 'w'));
ud.XData = [];
ud.Y3Data = [];
...
callbacks = {
'CopyFcn',       'GUIdisplay([], [], [], ''CopyBlock'', [], [])'; ...
'DeleteFcn',     'GUIdisplay([], [], [], ''DeleteBlock'', [], [])'; ...
'LoadFcn',       'GUIdisplay([], [], [], ''LoadBlock'', [], [])'; ...
'StartFcn',      sprintf('GUIdisplay([], [], [], ''Start'', [], ''%s'')', worldfile); ...
'StopFcn'        'GUIdisplay([], [], [], ''Stop'', [], [])'; ...
'NameChangeFcn', 'GUIdisplay([], [], [], ''NameChange'', [], [])'; ...
};
